...
//i <= result[0].length-1 , max # of iterations
//startingIndex + i <= result[0].length-1 , controls # of iterations



	for (var i = 1; startingIndex <= result[0].length-2 && startingIndex + i <= result[0].length-1 ; i++){
